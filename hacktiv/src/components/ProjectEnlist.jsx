...
function ProjectEnlisting(props) {
  ...
  const toggleDropdown = (index) => {
	...
	return (
		<>
		{!isCreating && !isView && !isEdit && !isDelete &&!isArchive ? (
			<>
			<button 
                ...
                <div className="relative inline-block text-left float-right">
                  ...
                  {openDropdownIndex === index && (
                    ...
                    >
                      ...
                      <a
                        href="#"
                        className="block px-4 py-2 text-tertiary-a hover:bg-accent-b hover:text-secondary" onClick={onEdit}
                      >
                        Edit
                      </a>
                      <a
                        href="#"
                        className="block px-4 py-2 text-tertiary-a hover:bg-accent-b hover:text-secondary" onClick={onDelete}
                      >
                        Delete
                      </a>
                      <a
                        href="#"
                        className="block px-4 py-2 text-tertiary-a hover:bg-accent-b hover:text-secondary" onClick={onArchive}
                      >
                        Archive
                      </a>
                    </div>
